...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_16 -L zynq_ultra_ps_e_vip_v1_0_16 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_16 -L zynq_ultra_ps_e_vip_v1_0_16 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_18 -L generic_baseblocks_v2_1_1 -L axi_register_slice_v2_1_30 -L fifo_generator_v13_2_9 -L axi_data_fifo_v2_1_29 -L axi_crossbar_v2_1_31 -L xlslice_v1_0_3 -L xlconcat_v2_1_5 -L lib_pkg_v1_0_3 -L lib_srl_fifo_v1_0_3 -L axi_uartlite_v2_0_34 -L interrupt_control_v3_1_5 -L axi_iic_v2_1_6 -L axi_gpio_v2_0_32 -L axi_timer_v2_0_32 -L axi_protocol_converter_v2_1_30 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot kr260 xil_defaultlib.kr260 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim kr260 -key {Behavioral:sim_1:Functional:kr260} -tclbatch cmd.tcl -protoinst "protoinst_files/kr260.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb kr260.wdb xsim.dir libdpi.so)
