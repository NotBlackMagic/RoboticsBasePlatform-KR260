...
class NBMPWM:
	def __init__(self, timer, frequency = 50, dc = 7.5):
		# Save timer instance
		self.timer = timer
	...
	# Set timer period (inverse of freqeuncy) in ms
	...
	# Set timer duty cycle, high time percentage
	def set_duty_cyle(self, percentage):
	...
	# Set timer high pulse, high time, duration in ms
	def set_pulse_high(self, ms):
